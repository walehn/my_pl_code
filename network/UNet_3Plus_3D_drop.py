...
from network.layers_3D import unetConv3
...
class UNet_3Plus_3D(nn.Module):
    ...
    def __init__(self, in_channels=3, n_classes=2, feature_scale=4, 
    is_deconv=True, is_batchnorm=True, channels=32, drop = 0.2):
        ...
        filters = [self.channels, self.channels*2, self.channels*4, self.channels*8, self.channels*16]
    ...
    def forward(self, inputs):
        ## -------------Encoder-------------
        h1 = self.dropout(self.conv1(inputs))  # h1->320*320*64

        h2 = self.maxpool1(h1)
        h2 = self.dropout(self.conv2(h2))  # h2->160*160*128

        h3 = self.maxpool2(h2)
        h3 = self.dropout(self.conv3(h3))  # h3->80*80*256

        h4 = self.maxpool3(h3)
        h4 = self.dropout(self.conv4(h4))  # h4->40*40*512

        h5 = self.maxpool4(h4)
        hd5 = self.dropout(self.conv5(h5))  # h5->20*20*1024

        ## -------------Decoder-------------
        h1_PT_hd4 = self.dropout(self.h1_PT_hd4_relu(self.h1_PT_hd4_bn(self.h1_PT_hd4_conv(self.h1_PT_hd4(h1)))))
        h2_PT_hd4 = self.dropout(self.h2_PT_hd4_relu(self.h2_PT_hd4_bn(self.h2_PT_hd4_conv(self.h2_PT_hd4(h2)))))
        h3_PT_hd4 = self.dropout(self.h3_PT_hd4_relu(self.h3_PT_hd4_bn(self.h3_PT_hd4_conv(self.h3_PT_hd4(h3)))))
        h4_Cat_hd4 = self.dropout(self.h4_Cat_hd4_relu(self.h4_Cat_hd4_bn(self.h4_Cat_hd4_conv(h4))))
        hd5_UT_hd4 = self.dropout(self.hd5_UT_hd4_relu(self.hd5_UT_hd4_bn(self.hd5_UT_hd4_conv(self.hd5_UT_hd4(hd5)))))
        hd4 = self.dropout(self.relu4d_1(self.bn4d_1(self.conv4d_1(
            torch.cat((h1_PT_hd4, h2_PT_hd4, h3_PT_hd4, h4_Cat_hd4, hd5_UT_hd4), 1))))) # hd4->40*40*UpChannels

        h1_PT_hd3 = self.dropout(self.h1_PT_hd3_relu(self.h1_PT_hd3_bn(self.h1_PT_hd3_conv(self.h1_PT_hd3(h1)))))
        h2_PT_hd3 = self.dropout(self.h2_PT_hd3_relu(self.h2_PT_hd3_bn(self.h2_PT_hd3_conv(self.h2_PT_hd3(h2)))))
        h3_Cat_hd3 = self.dropout(self.h3_Cat_hd3_relu(self.h3_Cat_hd3_bn(self.h3_Cat_hd3_conv(h3))))
        hd4_UT_hd3 = self.dropout(self.hd4_UT_hd3_relu(self.hd4_UT_hd3_bn(self.hd4_UT_hd3_conv(self.hd4_UT_hd3(hd4)))))
        hd5_UT_hd3 = self.dropout(self.hd5_UT_hd3_relu(self.hd5_UT_hd3_bn(self.hd5_UT_hd3_conv(self.hd5_UT_hd3(hd5)))))
        hd3 = self.dropout(self.relu3d_1(self.bn3d_1(self.conv3d_1(
            torch.cat((h1_PT_hd3, h2_PT_hd3, h3_Cat_hd3, hd4_UT_hd3, hd5_UT_hd3), 1))))) # hd3->80*80*UpChannels

        h1_PT_hd2 = self.dropout(self.h1_PT_hd2_relu(self.h1_PT_hd2_bn(self.h1_PT_hd2_conv(self.h1_PT_hd2(h1)))))
        h2_Cat_hd2 = self.dropout(self.h2_Cat_hd2_relu(self.h2_Cat_hd2_bn(self.h2_Cat_hd2_conv(h2))))
        hd3_UT_hd2 = self.dropout(self.hd3_UT_hd2_relu(self.hd3_UT_hd2_bn(self.hd3_UT_hd2_conv(self.hd3_UT_hd2(hd3)))))
        hd4_UT_hd2 = self.dropout(self.hd4_UT_hd2_relu(self.hd4_UT_hd2_bn(self.hd4_UT_hd2_conv(self.hd4_UT_hd2(hd4)))))
        hd5_UT_hd2 = self.dropout(self.hd5_UT_hd2_relu(self.hd5_UT_hd2_bn(self.hd5_UT_hd2_conv(self.hd5_UT_hd2(hd5)))))
        hd2 = self.dropout(self.relu2d_1(self.bn2d_1(self.Conv3d_1(
            torch.cat((h1_PT_hd2, h2_Cat_hd2, hd3_UT_hd2, hd4_UT_hd2, hd5_UT_hd2), 1))))) # hd2->160*160*UpChannels

        h1_Cat_hd1 = self.dropout(self.h1_Cat_hd1_relu(self.h1_Cat_hd1_bn(self.h1_Cat_hd1_conv(h1))))
        hd2_UT_hd1 = self.dropout(self.hd2_UT_hd1_relu(self.hd2_UT_hd1_bn(self.hd2_UT_hd1_conv(self.hd2_UT_hd1(hd2)))))
        hd3_UT_hd1 = self.dropout(self.hd3_UT_hd1_relu(self.hd3_UT_hd1_bn(self.hd3_UT_hd1_conv(self.hd3_UT_hd1(hd3)))))
        hd4_UT_hd1 = self.dropout(self.hd4_UT_hd1_relu(self.hd4_UT_hd1_bn(self.hd4_UT_hd1_conv(self.hd4_UT_hd1(hd4)))))
        hd5_UT_hd1 = self.dropout(self.hd5_UT_hd1_relu(self.hd5_UT_hd1_bn(self.hd5_UT_hd1_conv(self.hd5_UT_hd1(hd5)))))
        hd1 = self.dropout(self.relu1d_1(self.bn1d_1(self.conv1d_1(
...
'''
class UNet_3Plus_DeepSup_3D(nn.Module):
    def __init__(self, in_channels=3, n_classes=2, feature_scale=4, 
    is_deconv=True, is_batchnorm=True, channels=32, drop = 0.2):
        super(UNet_3Plus_DeepSup_3D, self).__init__()
        self.is_deconv = is_deconv
        self.in_channels = in_channels
        self.is_batchnorm = is_batchnorm
        self.feature_scale = feature_scale
    ...
    def forward(self, inputs):
        ...
        hd2 = self.relu2d_1(self.bn2d_1(self.Conv3d_1(
            torch.cat((h1_PT_hd2, h2_Cat_hd2, hd3_UT_hd2, hd4_UT_hd2, hd5_UT_hd2), 1)))) # hd2->160*160*UpChannels
...
'''
class UNet_3Plus_DeepSup_CGM_3D(nn.Module):

    #def __init__(self, in_channels=3, n_classes=1, feature_scale=4, is_deconv=True, is_batchnorm=True):
    def __init__(self, in_channels=3, n_classes=2, feature_scale=4, is_deconv=True, is_batchnorm=True, channels=32):
        super(UNet_3Plus_DeepSup_CGM_3D, self).__init__()
        self.is_deconv = is_deconv
        self.in_channels = in_channels
        self.is_batchnorm = is_batchnorm
        self.feature_scale = feature_scale
        self.chnnels = channels
